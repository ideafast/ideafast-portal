...
import { DatabaseOutlined, TeamOutlined, PoweroffOutlined, HistoryOutlined, SettingOutlined, ProjectOutlined, DesktopOutlined, NotificationOutlined } from '@ant-design/icons';
...
export const MainMenuBar: FunctionComponent<MainMenuBarProps> = ({ projects }) => (
    <div className={css.main_menubar}>
        ...
        <div>
            <NavLink to='/docs' title='Docs' className={({isActive}) => isActive ? css.clickedButton : undefined}>
                <div className={css.button}><NotificationOutlined /> Information</div>
            </NavLink>
        </div>
        {/*
        <div>
