...
export const logRouter = t.router({
    ...
    getLogs: baseProcedure.input(z.object({
        ...
        type: z.union([z.array(z.nativeEnum(enumEventType)), z.null()]),
        apiResolver: z.union([z.array(z.nativeEnum(enumAPIResolver)), z.null()]),
        event: z.union([z.array(z.string()), z.null()]),
        status: z.union([z.array(z.nativeEnum(enumEventStatus)), z.null()]),
        indexRange: z.union([z.array(z.number()), z.null()]),
        timeRange: z.union([z.array(z.number()), z.null()])
