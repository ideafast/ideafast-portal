...
export * from './config';
export * from './doc';
export const GQLRequests = { ...subscription, ...appUsers, ...organisation, ...pubkey, ...curation, ...data, ...files, ...log, ...permission, ...projects, ...query, ...study, ...user, ...standardization, ...config, ...doc };
