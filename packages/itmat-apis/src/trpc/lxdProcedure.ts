    ...
    _router() {
        return this.router({
            ...
            getInstanceState: this.baseProcedure.input(z.object({
                ...
                return await this.lxdManager.getInstanceState(input.container);
            }),
            ...
            updateInstance: this.baseProcedure.input(z.object({
                ...
                return await this.lxdManager.updateInstance(input.instanceName, input.payload);
            }),
            ...
            startStopInstance: this.baseProcedure.input(z.object({
                ...
                return await this.lxdManager.startStopInstance(input.instanceName, input.action);
            }),
            ...
            deleteInstance: this.baseProcedure.input(z.object({
                ...
                return await this.lxdManager.deleteInstance(input.instanceName);
            })
        });
    }
}